    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-700">+977-061453203</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-700">+977-014538687</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          <Mail className="h-5 w-5 text-gray-700 mt-1" />
          <div>
            <h3 className="font-medium">Order related inquiries</h3>
            <p className="text-gray-700">a.csplms@gmail.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="bg-gray-100 p-6 rounded-lg flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-medium">Chadra Surya Public Library</h3>
      ...
      <div className="w-full h-[400px] rounded-lg overflow-hidden border border-gray-200">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3515.908704411917!2d83.95!3d28.21!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDEyJzM2LjAiTiA4M8KwNTcnMDAuMCJF!5e0!3m2!1sen!2snp!4v1650000000000!5m2!1sen!2snp"
          width="100%"
          height="100%"
          style={{ border: 0 }}
      ...
      <div className="mt-4 bg-blue-50 p-4 rounded-lg">
        <div className="flex flex-col">
          ...
          <p className="text-gray-700">Lakeside, Pokhara 33700</p>
