...
public class RegisterUserService {
    ...
    @Autowired
    public RegisterUserService(UserRepository userRepository, RegisterUserMapper registerUserMapper, SaveEvidencesHelper saveEvidencesHelper, GetAuthUserUtil getAuthUserUtil) {
