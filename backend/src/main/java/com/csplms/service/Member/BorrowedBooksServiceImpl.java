...
public class BorrowedBooksServiceImpl implements BorrowedBooksService {
    ...
    @Autowired
    public BorrowedBooksServiceImpl(BorrowRepository borrowRepository, UserRepository userRepository, GetAuthUserUtil getAuthUserUtil, CategoryRepository categoryRepository, BookRepository bookRepository) {
