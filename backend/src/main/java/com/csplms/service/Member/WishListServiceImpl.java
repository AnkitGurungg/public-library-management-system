...
public class WishListServiceImpl implements WishListService {
    ...
    @Autowired
    public WishListServiceImpl(WishListRepository wishListRepository, UserRepository userRepository, WishListMapper wishListMapper, GetAuthUserUtil getAuthUserUtil, BookRepository bookRepository, CategoryRepository categoryRepository) {
