...
public class ReturnService {
    ...
    @Autowired
    public ReturnService(BorrowRepository borrowRepository, ReturnRepository returnRepository, ReturnHelper returnHelper, BookRepository bookRepository, FineService fineService, FineMapper fineMapper, FineRepository fineRepository, EmailUtil emailUtil, UserRepository userRepository) {
