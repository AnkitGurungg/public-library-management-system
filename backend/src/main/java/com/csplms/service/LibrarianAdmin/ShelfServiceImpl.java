...
public class ShelfServiceImpl implements ShelfService {
    ...
    @Autowired
    public ShelfServiceImpl(ShelfRepository shelfRepository, ShelfMapper shelfMapper, BookRepository bookRepository, GetAuthUserUtil getAuthUserUtil, UserRepository userRepository) {
